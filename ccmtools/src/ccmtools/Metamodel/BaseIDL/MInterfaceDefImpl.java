    ...
    implements MInterfaceDef
{
    ...
    public String toString(Set been_there)
    {
		if (been_there.contains(getIdentifier()))
			return "MInterfaceDef: " + getIdentifier();
		...
		String tmp2 =  "MInterfaceDef: " + identifier + " [" + Text.join(", ", tmplst) + "]";
//		String tmp = "MInterfaceDef: " + identifier;
//		if (ContainsList.size() > 0)
//			tmp  += " " + ContainsList.toString();
//		boolean isit = tmp.equals(tmp2);

		if (InterfaceDerivedFromList.size() > 0)
			tmp2 += " (bases: " + InterfaceDerivedFromList.toString() + ")";
		return tmp2;
}
